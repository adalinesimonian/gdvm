...
help-run-csharp-long = Գործարկել Godot տարբերակը C# աջակցության համար:

    Եթե տրված է, արժեքը անվերջակետում է լռելյայն տարբերակի համար, այլապես լռելյայն
    տարբերակը կօգտագործվի: Այսպիսի դեպքում, եթե դուք սահմանել եք լռելյայն տարբերակը
    "use --csharp"-ով, դուք կկարողանաք փորձել գործարկել նույն տարբերակը, բայց առանց C#
    աջակցության "run --csharp false"-ով: Միայն այն դեպքում է աշխատելու ակնարկություն,
    եթե աջակցության առանց տեղադրված տարբերակը չի տեղադրված: (Միայն գործարկեք "տեղադրել"
    այնտեղ:)
help-version = Տեղադրվող տարբերակը (օրինակ՝ 4), կամ "stable" վերջին կայուն տարբերակի համար:
help-version-long =
    Տեղադրվող տարբերակը (օրինակ՝ 4), կամ "stable" վերջին կայուն տարբերակի համար:

    Օրինակներ՝ 4.4-ը կտեղադրի Godot 4.4-ի վերջին կայուն թողարկումը: Եթե միայն նախնական
    թողարկումներ կան, ապա կտեղադրվի վերջին նախնական թողարկումը: 4.3-rc-ը կտեղադրի
    Godot 4.3-ի վերջին թողարկման թեկնածուն և այլն:
...
no-default-set = Լռելյայն տարբերակը սահմանված չէ: Գործարկեք "gdvm use <version>"՝ լռելյայն տարբերակը
    համակարգային մակարդակով սահմանելու համար, կամ "gdvm pin <version>"՝ լռելյայն տարբերակը
    ընթացիկ պանակի համար սահմանելու համար:

help-upgrade = Թարմացնել gdvm-ը վերջին տարբերակին

help-pin = «Գամել» Godot-ի տարբերակը ընթացիկ պանակում:
help-pin-long = «Գամել» Godot-ի տարբերակը ընթացիկ պանակում:

    Սա կստեղծի .gdvmrc ֆայլ ընթացիկ պանակում գամված տարբերակով: Երբ դուք
    կգործարկեք "gdvm run" այս պանակում կամ դրա ենթապանակներում, կօգտագործվի
    գամված տարբերակը լռելյայն տարբերակի փոխարեն:

    Սա օգտակար է, երբ ցանկանում եք օգտագործել որոշակի Godot տարբերակ նախագծի համար,
    առանց փոխելու լռելյայն տարբերակը ամբողջ համակարգում:
