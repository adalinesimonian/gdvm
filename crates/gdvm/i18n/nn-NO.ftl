...
error-config-path-overlap = Konfigurerte stiar må ikkje overlappe: { $key } ({ $path })
error-config-dir-not-empty = Nekar å bruke stien { $path } fordi ho allereie inneheld filer. Vel ein tom mappe eller ein ny sti.
