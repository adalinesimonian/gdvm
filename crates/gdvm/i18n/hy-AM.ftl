...
gdvm-toml-malformed = {"\u001b"}[33mԶգուշացում. { $path }-ի { -gdvm-toml(case: "definite") } անտեսվում է, քանի որ հնարավոր չէ վերլուծել. { $error }{"\u001b"}[0m
...
upgrade-starting = Սկսվում է { -gdvm(case: "genitive") } թարմացումը...
upgrade-downloading-latest = Ներբեռնում է { -gdvm(case: "genitive") } վերջին տարբերակը...
upgrade-complete = { -gdvm(case: "definite") } հաջողությամբ թարմացվեց!
...
registry-trust-warning = {"\u001b"}[33m{ $registry } ({ $url })-ը հատուկ ռեեստր է, ոչ թե պաշտոնականը: { -gdvm(case: "definite") } ստուգում է, որ ներբեռնումները համապատասխանում են ռեեստրի նշածին, բայց չի կարող ջանաչել, թե արդյոք դրանք անվտանգ են գործարկելու համար: Տեղադրեք դրանից միայն այն դեպքում, եթե վստահում եք նրան, ով այն կառավարում է:{"\u001b"}[0m
...
registry-project-override-conflict = {"\u001b"}[33mՆախագծի { -gdvm-toml(case: "definite") } վերասահմանում է { $registry } ռեեստրը (ձեր կարգավորումը՝ { $machine_url }) որպես { $project_url }: Նախագծի սահմանումն ունի առաջնահերթություն:{"\u001b"}[0m
...
registry-build-warn-local-hash = {"\u001b"}[33mՀաշվարկվում է տեղական ֆայլի հեշը՝ ենթադրելով, որ այն համապատասխանում է { $url }-ին: { -gdvm(case: "definite") } URL-ը չի ներբեռնում՝ ստուգելու համար:{"\u001b"}[0m
